...
<AppBar class="sticky top-0 left-0 w-full z-50 bg-surface-100-900/80 backdrop-blur-md">
	<AppBar.Toolbar class="max-w-6xl mx-auto flex items-center">
		<AppBar.Lead class="flex gap-2">
			<GripIcon />
		...
		<AppBar.Trail>
			...
			<a
				...
				href="https://github.com/shajidhasan/spoilerjs"
				target="_blank"
